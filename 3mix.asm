...
; different (especially during the montage) so consider the overlapped variables in the next section
	...
	Title_HorzScroll:	.ds 1	; SB: Horizontal scrolling of ground
...
UPDATERASTER_FIXEDFC	= 4	; SB: Fixed floor and ceiling; top two rows remain fixed at top of screen, bottom two rows at bottom
...
; Lower ranges are context-dependent
	...
	Music_MusBank:		.ds 1	; SB: New -- sets the current "music bank" for Set 2B/2C music (default 31, but grow, music, grow!)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	Obj2Obj_FlagNoHitChk:.ds 1	; SB: One-shot flag that skips the OAT_HITNOTKILL check in ObjectToObject_HitTest
...
CHNGTILE_SANDTOPMID = $33	; Quick sand stop and middle tile
	...
	Level_ChgTileEvent:	.ds 1	; When non-zero, queues a "change tile" event (SB: New feature, set bit 7 to update attributes too; single tile change only)
	...
	Player_Behind:		.ds 1	; When non-zero, Player is "behind the scenes" SB: Now a permanent flag, not a countdown
	...
	; SB: If bit 7 set, fixed ceiling is present as well
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	Map_UpdStarCoinsCnt:	.ds 1	; SB: Counter (from 3 downward) to update one star coin at a time (prevent full-screen flicker)
	...
	Map_WasAltExit:		.ds 1	; SB: If set, this was an alternate exit

	Map_DoFortressFX:	.ds 1	; SB: Kind of leftover, dunno if this will be revitalized??
...
Tile_Mem:	.ds 6480	; $6000-$794F Space used to store the 16x16 "tiles" that make up the World Map or Level
	...
	; SB: Removing N-Spade bonus from map
	;Map_NSpade_NextScore:	.ds 3	; $7968 (H)-$796A (L) treated as 3-byte integer


	; SB: Keep CP data in high RAM to prevent deletion on level exit
...
CFIRE_GRAVITY_NORMAL	= $16	; SB: Gravity normal
CFIRE_GRAVITY_REVERSE	= $17	; SB: Gravity reversed
...
OBJ_CFIRE_GRAVITY_NORMAL= $BC + CFIRE_GRAVITY_NORMAL - 1	; SB: Gravity normal (if above)
OBJ_CFIRE_GRAVITY_REVERSE= $BC + CFIRE_GRAVITY_REVERSE - 1	; SB: Gravity reversed (if below)
...
PF_BUNNYFLAP		= $51	; SB: Bunny ear flap down frame
...
TILE_QBLOCK		= $5F	; SB: Q-Block on map
TILE_FORTRUBBLE		= $60	; Mini-Fortress Rubble
TILE_GHOSTHOUSE_COMP	= $63	; SB: Ghost House complete
TILE_GHOSTHOUSE		= $65	; SB: Ghost House
...
TILE1_STARCOIN1		= $50	; SB: Star coin!
TILE1_STARCOIN2		= $51	; SB: Star coin!
TILE1_STARCOIN3		= $52	; SB: Star coin!
...
TILE1_FLAGTOP		= $81	; SB: Flag pole top
TILE1_FLAGPOLE		= $82	; SB: Flag pole ... pole
...
TILE3_STARCOIN1		= $4B	; SB: Star coin!
TILE3_STARCOIN2		= $4C	; SB: Star coin!
TILE3_STARCOIN3		= $4D	; SB: Star coin!
...
TILE3_FLAGTOP		= $8A	; SB: Flag pole top
TILE3_FLAGPOLE		= $8B	; SB: Flag pole ... pole
...
TILE4_FLAGBASE		= $37	; SB: Flag pole base (an interesting unused diamond block)
...
TILE4_LONGWOOD_L	= $57	; Long wooden block, left (SB: Moved from $4A to salvage generator)
...
TILE4_FLAGTOP		= $8A	; SB: Flag pole top
TILE4_FLAGPOLE		= $8B	; SB: Flag pole ... pole

TILE4_GREENBLOCK_UL	= $9A	; Green platform, upper left (SB: Moved +$10)
TILE4_GREENBLOCK_UM	= $9B	; Green platform, upper middle (SB: Moved +$10)
TILE4_GREENBLOCK_UR	= $9C	; Green platform, upper right (SB: Moved +$10)

TILE4_SMB2_GNDTOP	= $BD	; SB: SMB2 style top ground
...
TILE5_FLAGTOP		= $86	; SB: Flag pole top
TILE5_FLAGPOLE		= $87	; SB: Flag pole ... pole

; NOTE: Tile $99 and $9A will act like a door because of code in PRG008 after "Door1_OK"
TILE5_DIAMOND		= $96

TILE5_PIPEH3_B		= $BF	; Pipe horizontal 3 bottom (not enterable) (SB: FIXME: Legacy definition, no longer host, move to 11/13)
...
TILE7_FLAGTOP		= $86	; SB: Flag pole top
TILE7_FLAGPOLE		= $87	; SB: Flag pole ... pole
...
TILE9_STARCOIN1		= $47	; SB: Star coin!
TILE9_STARCOIN2		= $48	; SB: Star coin!
TILE9_STARCOIN3		= $49	; SB: Star coin!
...
TILE9_FLAGTOP		= $A0	; SB: Flag pole top
TILE9_FLAGPOLE		= $A1	; SB: Flag pole ... pole
...
TILE13_STARCOIN1	= $47	; SB: Star coin!
TILE13_STARCOIN2	= $48	; SB: Star coin!
TILE13_STARCOIN3	= $49	; SB: Star coin!
...
TILE14_SKY		= $02	; Sky
	...
	; SB: Interestingly, Nintendo built generators but not tiles for this...
...
TILE14_STARCOIN1	= $4B	; SB: Star coin!
TILE14_STARCOIN2	= $4C	; SB: Star coin!
TILE14_STARCOIN3	= $4D	; SB: Star coin!
...
TILE15_FLAGTOP		= $8B	; SB: Flag pole top
TILE15_FLAGPOLE		= $8C	; SB: Flag pole ... pole
